...
const raisedToTheThird = (arr) => {
  ...
  const exponentArray = [];
  arr.forEach((number) => {
    exponentArray.push(Math.pow(number, 3));
  });
...
const addOne = (arr) => {
  // Solution code here...
  const mappedArray = arr.map(x => x + 1);
...
const addQuestion = (arr) => {
  // Solution code here...
  const mappedQuestions = arr.map(x => x + '?');
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    loopedArray.push(Math.pow(2, arr[i]));
  }
...
const forEachTwoToThe = (arr) => {
  ...
  const eachedArray = [];
  arr.forEach((number) => {
    eachedArray.push(Math.pow(2, number));
  });
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const mappedArrayTwo = arr.map(x => Math.pow(2, x));

  return mappedArrayTwo;
};
