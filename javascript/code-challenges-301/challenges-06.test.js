...
const getNames = (arr) => {
  // Solution code here...
  const getName = arr.map((person) => {

    const stringArray = person.name.split('');
    const reversedString = stringArray.reduce((reversed, string) => {
...
const setStatusAsAuthor = (people) => {
  // Solution code here...
  console.log(people.forEach(person => person.isAuthor = true));
};
